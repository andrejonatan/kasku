...
<head>
    ...
    <title>Pembayaran Kas Bulanan - KASKU</title>
    <meta name="description" content="Form pembayaran uang kas bulanan kelas.">
    ...
    <div class="min-h-screen flex flex-col justify-center w-full max-w-lg mx-auto px-6 py-12 relative z-10">
        ...
        <div class="glass-card rounded-2xl p-8 w-full shadow-2xl">
            ...
            <div class="flex items-center gap-4 mb-8">
                <div class="w-12 h-12 rounded-xl flex items-center justify-center" style="background: linear-gradient(135deg, rgba(59,130,246,0.2), rgba(37,99,235,0.1)); border: 1px solid rgba(59,130,246,0.3);">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#60a5fa" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/></svg>
                </div>
                <div>
                    <h1 class="text-xl font-bold text-white">Pembayaran Kas Bulanan</h1>
                    <p class="text-kasku-muted text-sm">Iuran kas kelas per bulan</p>
                </div>
            </div>
            ...
            <div class="bg-white/5 border border-white/10 rounded-xl p-4 mb-6 flex items-center gap-4">
                ...
                @else
                    <div class="w-10 h-10 rounded-full bg-gradient-to-br from-kasku-primary to-blue-600 flex items-center justify-center text-white font-bold text-sm shrink-0">
                ...
                <div class="ml-auto">
                    <span class="text-xs px-2 py-1 rounded-full bg-blue-500/20 text-blue-400 border border-blue-500/30">Terautentikasi</span>
                </div>
            </div>
            ...
            <div class="bg-blue-500/10 border border-blue-500/30 rounded-xl p-4 mb-6">
                <div class="flex justify-between items-center">
                    <div>
                        <p class="text-blue-400 text-sm font-semibold">{{ $iuran->nama_iuran }}</p>
            ...
            <form method="POST" action="{{ route('payment.kas.post') }}" class="space-y-5">
                @csrf
                ...
                {{-- Submit --}}
                <div class="pt-2">
                    <button type="submit" id="btn-bayar-kas" class="btn-gold w-full justify-center py-3 text-sm font-semibold">
            ...
            <div class="mt-6 text-center text-xs text-kasku-muted">
                Ingin membayar Study Tour?
                <a href="{{ route('payment.tour') }}" class="text-kasku-accent hover:text-kasku-accent-light transition-colors font-medium">Klik di sini</a>
            </div>
        </div>
    </div>
